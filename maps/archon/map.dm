/datum/map/archon
	name			= "Archon"
	full_name		= "Archon ship"
	path			= "archon"

	station_name	= "FTUV Archon"
	station_short	= "Archon"
	dock_name		= "FTS Capitalist's Rest"
	boss_name		= "FTU Head Office"
...
/datum/map/archon/get_map_info()
	return "You're aboard the <b>[station_short]</b>, a [company_name] vessel affiliated with various other entities. \
